@if($chart->hasInformation())
    ...
    <script type="text/javascript">
        ...
        options: {
            ...
            title: {
                display: true,
                        text: {!! json_encode($chart->getChartTitle()) !!},
            },
                ...
                callbacks: {
                    ...
                    label: function(tooltipItem, chart) {
                        ...
                        if (datasetLabel != 'Average') {
                            window.total += parseFloat(number_format(tooltipItem.yLabel, 2));
                        }
                        return datasetLabel + ': ' + number_format(tooltipItem.yLabel, 2);
                    }
                <?php if ($chart->hasFooter()): ?>
                    ,
                    footer: function() {

                        return "Total: " + number_format(window.total, 2);
                    }
                    <?php endif;?>
                }
