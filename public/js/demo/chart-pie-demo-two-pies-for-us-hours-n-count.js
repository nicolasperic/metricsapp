...
var ctx = document.getElementById("usTypeAmount");
var usTypeAmount = new Chart(ctx, {
    type: 'doughnut',
    data: {
...
var ctxHours = document.getElementById("usTypeHours");
var usTypeHours = new Chart(ctxHours, {
    type: 'doughnut',
    data: {
        labels: usTypesLabels,//["Bugs", "Support", "Requirement"],
        datasets: [{
